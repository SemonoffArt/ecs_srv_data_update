# 🔄 Синхронизация тегов и мнемосхем ECS3

**Скрипт для синхронизации данных ECS3 с основного ECS сервера**
...
PowerShell скрипт для автоматизации процесса синхронизации данных ECS3. Скрипт копирует файлы базы данных и директории с сетевого сервера `ECS2261SVR02` на локальную машину, создавая резервные копии существующих данных перед заменой.
